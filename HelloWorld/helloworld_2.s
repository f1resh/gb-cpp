...
.LFB973:
	...
	movq	%rax, %rdi
.LEHB0:
	call	_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcmRKS3_@PLT
.LEHE0:
	leaq	-25(%rbp), %rax
	movq	%rax, %rdi
...
.LLSDACSE973:
	...
	.section	.rodata
.LC0:
	.string	"\320\237\321\200\320\270\320\262\320\265\321\202, \320\274\320\270\321\200!"
	.text
	.globl	main
	.type	main, @function
main:
.LFB1522:
	...
	movq	%rax, %rdi
.LEHB2:
	call	_ZNSt8literals15string_literalsli1sB5cxx11EPKcm
.LEHE2:
	leaq	-64(%rbp), %rax
	movq	%rax, %rsi
